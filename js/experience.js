...
// ===== Apparition en cascade au chargement (pas de scroll sur cette page) =====
const cibles = [
  document.querySelector('.experience__visuel'),
  ...document.querySelectorAll('.experience__contenu > *')
].filter(Boolean);
